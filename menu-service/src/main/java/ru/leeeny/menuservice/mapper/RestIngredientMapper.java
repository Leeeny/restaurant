...
public interface RestIngredientMapper {
	...
	MenuItemIngredientResponse toDto(IngredientDto ingredient);

	List<MenuItemIngredientResponse> toRestDtos(List<IngredientDto> ingredients);
