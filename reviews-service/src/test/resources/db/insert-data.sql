INSERT INTO review.ratings(menu_id)
values (1),
       (2),
       (3),
       (4),
...
INSERT INTO review.reviews(menu_id, created_by, comment, rate, created_at)
values (1, 'UserOne', 'CommentOne', 5, '2024-03-14 10:23:54'),
...
UPDATE review.ratings
SET rate_four = rate_four + 1
WHERE menu_id = 10;

UPDATE review.ratings
SET rate_three = rate_three + 1
WHERE menu_id = 10;

UPDATE review.ratings
SET rate_two = rate_two + 1
WHERE menu_id = 10;

UPDATE review.ratings
SET rate_one = rate_one + 1
WHERE menu_id = 10;
